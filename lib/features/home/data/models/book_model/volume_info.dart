...
class VolumeInfo extends Equatable {
  ...
  factory VolumeInfo.fromJson(Map<String, dynamic> json) => VolumeInfo(
        ...
        industryIdentifiers:
            (json['industryIdentifiers'] as List<dynamic>?)?.map((e) => IndustryIdentifier.fromJson(e as Map<String, dynamic>)).toList(),
        ...
        panelizationSummary:
            json['panelizationSummary'] == null ? null : PanelizationSummary.fromJson(json['panelizationSummary'] as Map<String, dynamic>),
